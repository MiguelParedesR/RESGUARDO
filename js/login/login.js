...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (custodiaForm) {
        custodiaForm.addEventListener('submit', (e) => {
            ...
            if (!passInput.value) { markInvalid(passField); passInput.focus(); return; }
    ...
    if (accordion) {
        ...
        headers.forEach(h => h.addEventListener('click', () => setActive(h.closest('.role-item'))));
    }
    // Limpiar estado inválido al teclear
    [['admin-pass','admin-pass-field'],['custodia-pass','custodia-pass-field'],['consulta-pass','consulta-pass-field']]
