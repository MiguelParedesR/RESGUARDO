...
(() => {
  ...
  const ROLE_BY_PATH = [
    ...
    {
      test: /\/html\/dashboard\/dashboard-custodia\.html$/i,
      roles: ["CUSTODIA"],
    },
    {
      test: /\/html\/dashboard\/custodia-registros\.html$/i,
      roles: ["CUSTODIA"],
    },
    {
      test: /\/html\/dashboard\/mapa-resguardo\.html$/i,
      roles: ["CUSTODIA"],
      needsServicio: true,
    },
    {
      test: /\/html\/dashboard\/dashboard-consulta\.html$/i,
      roles: ["CONSULTA"],
    },
  ];
